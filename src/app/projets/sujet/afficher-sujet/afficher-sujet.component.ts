...
export class AfficherSujetComponent implements OnInit {
  ...
  generatePDF(sujet: Sujet, action = 'open') {
    ...
    if (action === 'download') {
      pdfMake.createPdf(docDefinition as any).download(sujet.title);
